"""
URL configuration for TareasCRUD project.
...
from CRUD.views import (TareaListCreateAPIView, TareaRetrieveUpdateDestroyAPIView, 
                        TareaAsignadaListCreateAPIView, TareaAsignadaRetrieveUpdateDestroyAPIView, 
                        # TareaAsignadaList
)
